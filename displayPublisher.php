...
if ($mysqli->connect_error) {
    ...
    $sql = "SELECT pid AS PublisherID, name AS PublishingHouseName, year_established AS YearEstablished FROM Publisher;";
    ...
    <section>
        ...
        <table>
            ...
            <tr>
                ...
                <td><?php echo $rows['PublishingHouseName'];?></td>
                <td><?php echo $rows['YearEstablished'];?></td>
